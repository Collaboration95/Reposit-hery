...
<table width="789" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div class="main">
    <br>
    <a href="index.php">Home</a> > <a href="gallery.php">Gallery</a> > Centre Outing - Army Museum<br><br>
    </div>
			...
			<div id="container">
				...
				<div id="thumbs" class="navigation">
                    ...
                    for(x=1;x<=50;x++)
                        {
                        html+='<li>';
                        html+='<a class="thumb" href="gallery/images/outing1/s/'+x+'.jpg" title="Alex">';
                        html+='<img src="gallery/images/outing1/tn/'+x+'.jpg">';
                        html+='</a>';
                        html+='<div class="caption">';
                        html+='<div class="download">';
                        html+='<a href="gallery/images/outing1/b/'+x+'.jpg" target="_blank">Download (Right click -> Save As)</a>';
                        html+='</div>';
