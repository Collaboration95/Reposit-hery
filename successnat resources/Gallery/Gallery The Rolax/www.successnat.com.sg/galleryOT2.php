...
<script src="gallery/jquery-1.3.2.js"></script>
<script src="gallery/jquery.galleriffic.js"></script>
<script src="gallery/jquery.opacityrollover.js"></script>
...
<table width="789" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <div class="main">
    <br>
    <a href="index.php">Home</a> > <a href="gallery.php">Gallery</a> > Centre Outing - The Rolax<br><br>
    </div>
	...
	<div id="page">
			...
			<div id="container">
				...
				<div id="thumbs" class="navigation">
                    ...
                    for(x=1;x<=382;x++)
                        {
                        html+='<li>';
                        html+='<a class="thumb" href="gallery/images/outing2/s/'+str(x)+'.jpg" title="Alex">';
                        html+='<img src="gallery/images/outing2/tn/'+str(x)+'.jpg">';
                        html+='</a>';
                        html+='<div class="caption">';
                        html+='<div class="download">';
                        html+='<a href="gallery/images/outing2/b/'+str(x)+'.jpg" target="_blank">Download (Right click -> Save As)</a>';
                        html+='</div>';
                                    
                        html+='<div class="image-title"></div>';
                        html+='<div class="image-desc"></div>';
                        html+='</div>';
                        html+='</li>';
                        }
                   document.write(html);
		...
		<script type="text/javascript">
			jQuery(document).ready(function($) {
				...
				$('div.navigation').css({'width' : '258px', 'float' : 'left'});
